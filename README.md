![React Note App](./Screenshot.png)

# Made with ❤️ by Yao Adzikah [https://bharaniyhao.github.io/yaw.github.io/]https://www.linkedin.com/in/yao-adzikah/]
...
In the project, we will be creating a simple note taking web application.. We will do all the CRUD operations. We will use `React.js` and to manage our states.
